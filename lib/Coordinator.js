 ...
 * @param {number|string} [options.timeout] - lock expire time. Default is 10 times more than the interval. Set to 0 to disable timeout
...
Coordinator.prototype.schedule = function (options, fn) {
	...
	var timeout = options.timeout === undefined ? 10 * options.interval : time(options.timeout)
